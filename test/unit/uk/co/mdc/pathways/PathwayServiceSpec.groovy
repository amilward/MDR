...
class PathwayServiceSpec extends Specification{
    ...
    def "topLevelPathways returns the correct number of pathways"(){
        ...
        def p2 = new Pathway(name:"Pathway 2", isDraft: false)
        p2.save()
        def p3 = new Pathway(name:"Pathway 3", isDraft: false)
        p3.save()
