...
<html>
	<head>
		...
		<parameter name="name" value=" CREATE EXTERNAL REFERENCE " />
	</head>
	<body>
		<header>
			<g:form url="[action:'save',controller:'externalReference']">
		...
		<div class="box">
		<div id="create-externalReference" class="content scaffold-create" role="main">
			...
			<g:form id="createForm" method="post" url="[action:'save',controller:'externalReference']">
				<fieldset class="form">
