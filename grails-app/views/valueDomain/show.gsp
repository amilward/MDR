		...
		<div class="box">
			<table class="table table-hovered">
				...
				<g:if test="${valueDomainInstance?.regexDef}">
					<tr>
						<td class="left_col_show"><span id="name-label" ><g:message code="valueDomain.regexDef.label" default="Regex Definition" /></span></td>
				...
				<g:if test="${valueDomainInstance?.unitOfMeasure}">
					<tr>
						<td class="left_col_show"><span id="name-label" ><g:message code="valueDomain.unitOfMeasure.label" default="Regex Definition" /></span></td>
				...
				<g:if test="${relationshipTypes}">
					...
					<g:if test="${valueDomainInstance.relations(relationshipType.name)}" >
					<tr>
