...
<html>
	<head>
		...
		<parameter name="name" value=" CREATE RELATIONSHIP ELEMENT " />
	</head>
	<body>
		<header>
			<g:form url="[action:'save',controller:'relationshipType']">
		...
		<div id="create-relationshipType" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${relationshipTypeInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form id="createForm" method="post" url="[action:'save',controller:'relationshipType']">
				<fieldset class="form">
