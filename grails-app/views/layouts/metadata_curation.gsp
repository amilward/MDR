            ...
            <ul id="menu" class="unstyled accordion collapse in">
                ...
                <li class="accordion-group "><a data-parent="#menu"
                    ...
                    <li class="accordion-group "><a data-parent="#menu"
                            ...
                            class="icon-sitemap icon-large"></i> Relationships
                </a>
                    <ul class="collapse " id="dataElementConcepts-nav">
                        <li><g:link action="list" controller="Relationship">
                            <i class="icon-angle-right"></i> List </g:link></li>
                        <li><g:link action="create" controller="Relationship">
                            <i class="icon-angle-right"></i> Create </g:link></li>
                    </ul></li>
                    <li class="accordion-group "><a data-parent="#menu"
                                                data-toggle="collapse" class="accordion-toggle"
                                                data-target="#externalReference-nav"> <i
                            class="icon-external-link icon-large"></i> Relationship Types
                </a>
                    <ul class="collapse " id="externalReference-nav">
                        <li><g:link action="list" controller="RelationshipType">
                            <i class="icon-angle-right"></i> List </g:link></li>
                        <li><g:link action="create" controller="RelationshipType">
                            <i class="icon-angle-right"></i> Create </g:link></li>
                    </ul></li>
                <li class="accordion-group "><a data-parent="#menu"
                                                data-toggle="collapse" class="accordion-toggle"
