...
import org.springframework.transaction.annotation.Transactional
	...
	/* *********************************************************************
	 * This service allows the user to access the value domain catalogue
...
class ValueDomainService {
	...
	@PreAuthorize('hasPermission(#id, "uk.co.mdc.catalogue.ValueDomain", read) or hasPermission(#id, "uk.co.mdc.catalogue.ValueDomain", admin)')
