...
<div class="fieldcontain ${hasErrors(bean: pathwaysModelInstance, field: 'refId', 'error')} ">
	<label for="refId">
		<g:message code="pathwaysModel.refId.label" default="Ref Id" />
		
	</label>
	<g:textField name="refId" value="${pathwaysModelInstance?.refId}"/>
</div>
