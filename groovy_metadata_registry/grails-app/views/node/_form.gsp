...
<div class="fieldcontain ${hasErrors(bean: nodeInstance, field: 'mandatoryInputs', 'error')} ">
	...
	<g:select name="mandatoryInputs" from="${uk.co.mdc.model.Collection.list()}" multiple="multiple" optionKey="id" size="5" value="${nodeInstance?.mandatoryInputs*.id}" class="many-to-many"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: nodeInstance, field: 'mandatoryOutputs', 'error')} ">
	...
	<g:select name="mandatoryOutputs" from="${uk.co.mdc.model.Collection.list()}" multiple="multiple" optionKey="id" size="5" value="${nodeInstance?.mandatoryOutputs*.id}" class="many-to-many"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: nodeInstance, field: 'optionalInputs', 'error')} ">
	...
	<g:select name="optionalInputs" from="${uk.co.mdc.model.Collection.list()}" multiple="multiple" optionKey="id" size="5" value="${nodeInstance?.optionalInputs*.id}" class="many-to-many"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: nodeInstance, field: 'optionalOutputs', 'error')} ">
	...
	<g:select name="optionalOutputs" from="${uk.co.mdc.model.Collection.list()}" multiple="multiple" optionKey="id" size="5" value="${nodeInstance?.optionalOutputs*.id}" class="many-to-many"/>
</div>
