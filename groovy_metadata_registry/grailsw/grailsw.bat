...
set AGENT_STRING=-javaagent:@wrapperDir@/springloaded-core-1.1.1.jar -noverify -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=@wrapperDir@/grails-wrapper-runtime-2.2.1.jar;@wrapperDir@;.
